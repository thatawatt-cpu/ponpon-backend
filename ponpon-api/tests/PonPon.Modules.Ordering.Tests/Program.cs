...
var tests = new (string Name, Action Run)[]
{
    ...
    (nameof(PricingPipelineTests.IgnoresInactiveFlashSale),
        new PricingPipelineTests().IgnoresInactiveFlashSale),
    (nameof(PricingPipelineTests.FixedCouponDoesNotDiscountShipping),
        new PricingPipelineTests().FixedCouponDoesNotDiscountShipping),
    ...
    (nameof(PricingPipelineTests.RejectsInvalidCouponWithStructuredError),
        new PricingPipelineTests().RejectsInvalidCouponWithStructuredError),
    (nameof(PricingPipelineTests.RejectsProductIneligibleCouponWithStructuredError),
        new PricingPipelineTests().RejectsProductIneligibleCouponWithStructuredError),
    (nameof(PricingPipelineTests.RejectsCouponBelowMinimumSubtotalWithStructuredError),
        new PricingPipelineTests().RejectsCouponBelowMinimumSubtotalWithStructuredError),
    ...
    (nameof(CheckoutPricingQuoteServiceTests.SelectsDefaultShippingChannelWhenNotProvided),
        new CheckoutPricingQuoteServiceTests().SelectsDefaultShippingChannelWhenNotProvided)
};
